...
var express = require('express'),					     // 加载express模块
    ...
    ueditor = require('ueditor-nodejs'),            //百度编辑器 
    ...
    dbUrl = 'mongodb://127.0.0.1/blog';               // 连接本地数据库及数据库名称
...
app.use(session({
	secret:'blog',                       // 设置的secret字符串，来计算hash值并放在cookie中
	resave: false,                        // session变化才进行存储
	saveUninitialized: true,// 使用mongo对session进行持久化，将session存储进数据库中
